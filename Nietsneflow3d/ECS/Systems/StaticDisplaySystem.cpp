...
void StaticDisplaySystem::execSystem()
{
    ...
    for(uint32_t i = 0; i < mVectNumEntity.size(); ++i)
    {
        ...
        //DRAW WEAPON
        SpriteTextureComponent *spriteComp = stairwayToComponentManager().
                searchComponentByType<SpriteTextureComponent>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::WEAPON)], Components_e::SPRITE_TEXTURE_COMPONENT);
        assert(spriteComp);
        ...
        if(weaponComp->m_weaponsData[i].m_posses)
        {
            ...
            if(static_cast<uint32_t>(i) == weaponComp->m_currentWeapon)
            {
                PositionVertexComponent *posCompCursor = stairwayToComponentManager().
                        searchComponentByType<PositionVertexComponent>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::CURSOR_WEAPON_PREVIEW)],
                                                                       Components_e::POSITION_VERTEX_COMPONENT);
                SpriteTextureComponent *spriteCompCursor = stairwayToComponentManager().
                        searchComponentByType<SpriteTextureComponent>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::CURSOR_WEAPON_PREVIEW)],
                                                                      Components_e::SPRITE_TEXTURE_COMPONENT);
...
{
    PositionVertexComponent *posComp = stairwayToComponentManager().
            searchComponentByType<PositionVertexComponent>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::WEAPON)],
                                                           Components_e::POSITION_VERTEX_COMPONENT);
    TimerComponent *timerComp = stairwayToComponentManager().
            searchComponentByType<TimerComponent>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::WEAPON)],
                                                  Components_e::TIMER_COMPONENT);
    MemPositionsVertexComponents *memPosComp = stairwayToComponentManager().
            searchComponentByType<MemPositionsVertexComponents>(playerComp->m_vectEntities[static_cast<uint32_t>(PlayerEntities_e::WEAPON)],
