                                    ...
                                    WeaponComponent *weaponComp)
{
    ...
    writeComp->m_fontSpriteData[0] = m_ptrFontData->getWriteData(writeComp->m_vectMessage[0].second, writeComp->m_numTexture, Font_e::BASE);
}
...
void GraphicEngine::confWriteComponent(WriteComponent *writeComp)
{
    ...
    {
        writeComp->m_fontSpriteData.emplace_back(m_ptrFontData->getWriteData(writeComp->m_vectMessage[i].second, writeComp->m_numTexture, Font_e::BASE));
    }
}
